        ...
        <Box width="100%" height="100%">
            ...
            <Grid container direction="column"
                ...
                {(searchInput.length >= 1 && dataFiltered !== [])
                    ? (dataFiltered !== [])
                        ? <ListStationScreen stations={dataFiltered} setEditing={setEditing} chosenStation={chosenStation} setChosenStation={setChosenStation} needLoading={needLoading} setNeedLoading={setNeedLoading} />

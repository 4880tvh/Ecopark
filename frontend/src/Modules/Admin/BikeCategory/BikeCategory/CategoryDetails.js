        ...
        <Box>
            <Grid container sx={{
                ...
                <Grid sx={{
                    ...
                    <Grid container item direction="column">
                        <Grid container item direction="row">
                            ...
                            <Typography variant="h2" sx={{ margin: "0% 20% 2% 14%" }} id="textbikecategory">{data.data.name}</Typography>

                        </Grid>
                        <Grid container item direction="row">

                            <Typography variant="h5" sx={{ margin: "0% 20% 2%" }} id="textbikecategory">Số lượng: {data.length}</Typography>
                ...
                <Grid container item direction="column">
                    {/* <Grid container item direction="row">
                        <Grid item xs={6} >
                            <Typography variant="h5" sx={{ marginLeft: "20%" }} id="textbikecategory">Loại xe: {data.data.name}</Typography>
                        </Grid>
                        <Grid item xs={6}>

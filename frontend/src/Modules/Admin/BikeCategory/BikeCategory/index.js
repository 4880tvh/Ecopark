...
export default function BikeCategories() {
  ...
  const [url, setUrl] = useState(
    "https://nmcnpm.herokuapp.com/api/v2/category"
  );
  async function getCategory() {
    ...
    axios
      ...
      .then((doc) => {
        ...
        getCategoryByID(doc.data.data[0]._id).then((data) => {
    ...
    >
      ...
      {edit && (
        <EditCategory
          ...
          setNeedLoading={setNeedLoading}
          needLoading={needLoading}
          currentCategory={chosenCategory.data}
        ></EditCategory>
      )}
              ...
              >
                ...
                <div className="dropdown-list">
                  <div
                    ...
                    onClick={(e) =>
                      setUrl(
                        "https://nmcnpm.herokuapp.com/api/v2/category?sortBy=priceLowToHigh"
                      )
                    }
                  >
                    Giá thấp - cao
                  ...
                  <div
                    ...
                    onClick={(e) =>
                      setUrl(
                        "https://nmcnpm.herokuapp.com/api/v2/category?sortBy=priceHighToLow"
                      )
                    }
                  >
                    Giá cao - thấp

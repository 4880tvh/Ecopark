...
export default function RenderBarChart() {
  ...
  data1.forEach((element) =>
    d1.push({name: element.bikeName, number: element.bikeNumber})
  );
    ...
    <Box container className={classes.container}>
      ...
      >
        <Grid container item xs={6} direction="column">
          <Grid
            container
            sx={{width: "100%", justifyContent: "center", paddingTop: "70px"}}
          >
          ...
          <Grid container sx={{justifyContent: "center"}}>
            <Typography variant="h5" align="center" sx={{position: "absolute"}}>
              Theo trạng thái
            </Typography>
          </Grid>
        </Grid>
